...
namespace GoodNewsAggregator.DAL.Core.Migrations
{
    ...
    [Migration("20210628101816_RefreshToken")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GoodNewsAggregator.DAL.Core.Entities.User", b =>
                {
                    b.OwnsMany("GoodNewsAggregator.DAL.Core.Entities.RefreshToken", "RefreshTokens", b1 =>
                        {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("GoodNewsAggregator.DAL.Core.Entities.Role", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("GoodNewsAggregator.DAL.Core.Entities.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
